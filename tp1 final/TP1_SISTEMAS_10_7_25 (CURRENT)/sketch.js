...
///////////////////////<<<<<------TRAZOS FONDO----->>>>//////////////////////////
//idea: usar el map como valor para el cambio dinamico
if(empezoElSonido && amp > 0.010 ){//sonido agudo
  console.log("funca");


    // Limpiar el PGraphics antes de redibujar
  pg.clear();
  // Puedes ajustar la cantidad de imágenes y su posición según tu diseño
  for (let i = 0; i < canT; i++) {
    let randomColor = color(random(255), random(255), random(255));
    push();
    pg.tint(randomColor);
    // Dibuja la imagen en una posición random o fija
    pop();

  /*for (let i = 0; i < trazos.length; i++) {
    console.log("funca el for");
    push();
    pg.tint(tam);
    pop();*/
  }
